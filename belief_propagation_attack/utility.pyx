...
def load_sca_model(model_file):
    ...
    try:
        if string_contains(model_file, 'rankloss'):
            ...
            model = load_model(model_file, custom_objects={'tf_median_probability_loss': tf_median_probability_loss})load_model(model_file, custom_objects={'tf_rank_loss': tf_rank_loss})
    except:
