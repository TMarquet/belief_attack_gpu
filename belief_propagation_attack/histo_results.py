...
k_median_rank = [120,106,114,100,118,102,127,110,125,63,127,104,80,57,100,69]
p_median_rank = [122,66,127,121,124,65,125,118,121,62,121,113,107,60,111,68]
p_2_round_rank = []
t_median_rank = [68,77,77,76,68,68,67,68,62,65,66,65,64,63,65,61]
h_median_rank = []
xt_median_rank = []
xk_median_rank = []
cm_median_rank = []
...
k_median_proba = [0.39,0.40,0.34,0.40,0.38,0.43,0.35,0.40,0.36,0.73,0.34,0.40,0.34,0.77,0.41,0.45]
p_median_proba = [0.39,0.70,0.39,0.39,0.39,0.70,0.39,0.39,0.39,0.73,0.39,0.39,0.40,0.74,0.40,0.51]
p_2_round_proba = []
t_median_proba = [0.52,0.48,0.48,0.48,0.52,0.51,0.52,0.51,0.55,0.53,0.54,0.54,0.55,0.70,0.55,0.57]
h_median_proba = []
xt_median_proba = []
xk_median_proba = []
cm_median_proba = []
