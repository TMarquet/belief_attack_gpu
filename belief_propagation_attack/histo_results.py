...
# [115.0, 113.0, 103.0, 100.0, 116.0, 101.0, 122.0, 98.0, 111.0, 53.0, 115.0, 96.0, 100.0, 50.0, 99.0, 92.0, 73.0, 70.0, 86.0, 99.0, 84.0, 94.0, 76.0, 79.0, 77.0, 71.0, 72.0, 70.0, 73.0, 74.0, 90.0, 98.0])
s_COMBINE_median_rank = [35.0, 24.0, 48.0, 72.0, 33.0, 82.0, 71.0, 79.0, 31.0, 68.0, 70.0, 64.0, 27.0, 46.0, 74.0, 68.0, 38.0, 30.0, 59.0, 73.0, 38.0, 83.0, 70.0, 87.0, 32.0, 68.0, 70.0, 60.0, 30.0, 46.0, 75.0, 71.0]
 #                       [31.0, 14.0, 27.0, 29.0, 27.0, 22.0, 31.0, 30.0, 30.0, 17.0, 62.0, 54.0, 30.0, 39.0, 66.0, 74.0]
p_COMBINE_median_rank = [112,63,122,110,110,58,115,108,109,57,106,105,112,72,112,97,77,69,75,84,78,75,83,83,76,75,85,87,80,80,84,83]
                         #[114.0, 66.0, 123.0, 108.0, 110.0, 60.0, 116.0, 107.0, 109.0, 58.0, 108.0, 107.0, 112.0, 72.0, 114.0, 97.0, 74.0, 76.0, 70.0, 89.0, 75.0, 75.0, 83.0, 103.0, 75.0, 75.0, 85.0, 105.0, 77.0, 81.0, 87.0, 105.5] 

t_COMBINE_median_rank =[70.0, 50.0, 63.0, 63.0, 57.0, 40.0, 57.0, 55.0, 55.0, 34.0, 53.5, 53.0, 53.0, 32.0, 53.0, 54.0, 67.0, 61.0, 76.0, 91.0, 91.0, 82.5, 89.0, 92.0, 89.0, 84.0, 92.0, 89.0, 87.0, 78.0, 91.0, 95.5]
...
k_COMBINE_median_proba = [0.39,0.42,0.43,0.42,0.4,0.6,0.4,0.44,0.41,0.79,0.4,0.44,0.29,0.85,0.44,0.52,0.36,0.36,0.45,0.34,0.40,0.31,0.41,0.47,0.47,0.50,0.5,0.5,0.46,0.38,0.37,0.17]
                      #  [0.39626723, 0.36208476, 0.4123194, 0.42109424, 0.36526513, 0.47989935, 0.37042645, 0.41776635, 0.3962687, 0.7767043, 0.3938827, 0.41919006, 0.28562334, 0.8140548, 0.41594133, 0.3461374, 0.5160343, 0.54609943, 0.45834994, 0.4105295, 0.4580807, 0.36713965, 0.52192044, 0.49912673, 0.5025033, 0.5336221, 0.52359747, 0.53812875, 0.52239867, 0.4657987, 0.4233429, 0.3071499]
s_COMBINE_median_proba = [0.8340867, 1.1183634, 0.63963234, 0.5429022, 0.9156659, 0.4736061, 0.53365063, 0.49785916, 0.974964, 0.56085754, 0.55108014, 0.55968026, 1.11081101, 0.8231517, 0.51061213, 0.54890085, 0.804439, 0.8571037, 0.47703553, 0.5346647, 0.7860447, 0.47590486, 0.53243125, 0.4599289, 0.9605047, 0.56279995, 0.55249818, 0.5920737, 1.10010583, 0.8151276, 0.5154483, 0.5308167]
 #[0.009776782, 0.020714263, 0.010986799, 0.010546331, 0.011159246, 0.013095876, 0.009958691, 0.010134112, 0.010220772, 0.016660009, 0.00591328, 0.0065713376, 0.01024342, 0.009220047, 0.005806502, 0.0052091666]
...
p_COMBINE_median_proba = [0.4,0.69,0.39,0.39,0.4,0.69,0.39,0.39,0.4,0.74,0.4,0.41,0.4,0.47,0.43,0.42,0.54,0.56,0.55,0.51,0.53,0.54,0.49,0.49,0.53,0.52,0.47,0.47,0.5,0.48,0.48,0.49]
                        #[0.3979313, 0.67716427, 0.390657, 0.40423702, 0.40190527, 0.63603385, 0.3953407, 0.4063134, 0.40218597, 0.7297259, 0.40306645, 0.40509184, 0.40378473, 0.46078176, 0.4029098, 0.4225041, 0.5497764, 0.52352715, 0.55865375, 0.49000625, 0.53532254, 0.53899074, 0.4728847, 0.27417343, 0.5254926, 0.51379106, 0.44677756, 0.29088855, 0.50467565, 0.4818381, 0.44615204, 0.29520318]
t_COMBINE_median_proba =  [0.5451604, 0.66429097, 0.5842476, 0.58564115, 0.63055577, 0.77748764, 0.618291, 0.63260086, 0.64185034, 0.945764, 0.645266, 0.64760186, 0.66583715, 1.0612793, 0.63397284, 0.6320418, 0.541268, 0.53767855, 0.489352, 0.4476116, 0.43308046, 0.4456965, 0.4384969, 0.4301711, 0.43494347, 0.44275434, 0.43503763, 0.44017183, 0.4488356, 0.4553772, 0.4300962, 0.4252607]
