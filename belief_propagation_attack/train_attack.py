...
### CNN Best model
def cnn_best(input_shape=(16,256), learning_rate=0.00001, filters = 3, classes=256, dense_units=100,pooling = [0,1,2],dense_layers = 3,size = [64,128,256]):
    # From VGG16 design
...
def train_variable_model(variable,mlp = False,cnn= False,epochs = 100,batch_size = 10):
    ...
    for i in range(10000):
        ...
        ranks.append(get_rank_from_prob_dist(all_score[i],temp_label[i]))
        ranks_base.append(get_rank_from_prob_dist(s[var_number-1][i],temp_label[i]))
