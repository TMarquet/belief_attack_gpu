...
if __name__ == "__main__":
    ...
    train_variable_model('all',X, X_l, V, V_l, mlp=USE_MLP, cnn=USE_CNN, cnn_pre=USE_CNN_PRETRAINED, lstm=USE_LSTM,combine = COMBINE, input_length=INPUT_LENGTH, add_noise=ADD_NOISE, epochs=EPOCHS,
